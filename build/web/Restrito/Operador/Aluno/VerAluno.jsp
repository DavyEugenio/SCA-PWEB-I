...
<html lang="pt">
        ...
        <div class="site-wrap">
            ...
            <div id="conteudo">
                ...
                <div id="dados">
                    ...
                    Turma: <a href="/PWeb_SCA__DGJ_/Restrito/Operador/Turma/VerTurma.jsp?id=<%=turma.getId()%>"><%=turma.getAno() + "." + turma.getSemestre() + " - " + turma.getTurno()%></a><br>
    ...
    <script>
                                function Resultado() {
                                    ...
                                    window.history.pushState("data", "title", "/PWeb_SCA__DGJ_/Restrito/Operador/Aluno/VerAluno.jsp?sage=" +<%=aluno.getSage()%>);
                                    if (msg !== "null") {
                                        alert(msg);
                                    }
                                }
                                function Confirmar(id) {
                                    if (confirm("Deseja excluir a frequência: " + id + "?")) {
                                        window.location.replace("../../../ExcluirFrequencia?id=" + id + "&sage=" +<%=aluno.getSage()%>);
                                    }
                                }
    </script>
</html>

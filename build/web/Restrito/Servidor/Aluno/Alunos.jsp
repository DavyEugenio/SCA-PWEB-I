    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" onload="Resultado()">
        <div class="site-wrap">
            ...
            <div id="conteudo">
                ...
                <table class="table">
                    <thead class="thead-light"><tr><th></th><th>Sage</th><th>Nome</th><th>Turma</th><th>Curso</th><th>Status</th></tr></thead>
                    <tbody>
                        ...
                        <tr class="alunos" id="<%=curso.getId()%>">
                            <td></td>
                            <td><%=aluno.getSage()%></td>
                            <td><a href="/PWeb_SCA__DGJ_/Restrito/Servidor/Aluno/VerAluno.jsp?sage=<%=aluno.getSage()%>"><%=aluno.getNome()%></a></td>
                            <td><a href="/PWeb_SCA__DGJ_/Restrito/Servidor/Turma/VerTurma.jsp?id=<%=turma.getId()%>"><%=turma.getAno() + "." + turma.getSemestre() + " - " + turma.getTurno()%></a></td>

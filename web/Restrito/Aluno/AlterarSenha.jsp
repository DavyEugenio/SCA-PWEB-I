...
<html>
    ...
    <script>
                            window.history.pushState("data", "title", "/PWeb_SCA__DGJ_/Restrito/Aluno/AlterarSenha.jsp");
    </script>
    <script type="text/javascript">
        ...
        function validarSenha() {
            if (asenha.value !== "<%=aluno.getSenha()%>") {

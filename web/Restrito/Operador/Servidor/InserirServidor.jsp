...
<html lang="pt">
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" onload="Resultado()">
        <div class="site-wrap">
            ...
            <div id="conteudo">
                <form action="../../../InserirServidor" method="post">
                    <div class="container">
                        <h2>Inserir Novo Servidor:</h2>
                        <label><b>Siape:</b></label><br>
                        <input type="text" name="siape" placeholder="Digite o Siape:" required>
                        <label><b>Nome:</b></label><br>
                        <input type="text" name="nome" placeholder="Digite o Nome:" required>
                        <label><b>Função:</b></label><br>
                        <input type="text" placeholder="Digite a Função" name="funcao" required>
                        <label for="psw"><b>Senha</b></label>
                        <input type="password" placeholder="Digite a senha" name="senha" id="senha" required>
                        <label for="psw-repeat"><b>Confirme a Senha</b></label>
                        <input type="password" placeholder="Confirme a senha" id="c_senha" required>
                        <label><b>Tipo:</b></label><br>
                        <table>
                            <tr><td><label class="labels">Servidor:</label></td><td><input type="radio" name="tipo" value="servidor"></td></tr>
                            <tr><td><label class="labels">Operador:</label></td><td><input type="radio" name="tipo" value="operador"></td></tr>
                        </table>

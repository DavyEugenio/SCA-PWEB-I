            ...
            <div id="conteudo">
                <div id="dados">
                    ...
                    <select id="cursos">
                        ...
                        %>
                        <option value="<%=curso.getId()%>"><%=curso.getNome() + " - " + curso.getModalidade()%></option>
                        <%
                            };
                        %>
                    </select><br>
                ...
                <table class="table">
                    <thead class="thead-light"><tr><th></th><th>ID</th><th>Ano</th><th>Semestre</th><th>Turno</th><th>Curso</th><th>Opções</th></tr></thead>    
                    <tbody>        

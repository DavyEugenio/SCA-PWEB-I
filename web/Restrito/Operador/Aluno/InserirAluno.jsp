...
<html lang="pt">
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" onload="Resultado()">
        <div class="site-wrap">
            ...
            <div id="conteudo">
                <form action="../../../InserirAluno" method="post" required>
                    <div class="container">
                        <br>
                        <h2>Inserir Novo Aluno:</h2>
                        <label><b>Sage:</b></label>
                        <input type="text" name="sage" placeholder="Digite o Sage:" required>
    ...
    <script type="text/javascript">
                                    ...
                                    var curso = document.getElementsByClassName("curso"), cursos = document.getElementById("cursos"), turma = document.getElementsByClassName("turma");
                                    function Curso() {

    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" onload="Resultado()">
        <div class="site-wrap">
                                    ...
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="Servidor/InserirServidor.jsp">Servidor</a>
                                                <a class="dropdown-item" href="Curso/InserirCurso.jsp">Curso</a>
                                                <a class="dropdown-item" href="Turma/InserirTurma.jsp">Turma</a>
                                                <a class="dropdown-item" href="Aluno/InserirAluno.jsp">Aluno</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="../../ListarServidores">Servidores</a>
            ...
            <div id="conteudo">
                ...
                <div id="dados">
                    ...
                    Siape: <%=operador.getSiape()%><br>
                    Nome: <%=operador.getNome()%><br>
                    Função: <%=operador.getFuncao()%><br>
                </div>
            </div>
        ...
        <script>
                                function Resultado() {
                                    ...
                                    window.history.pushState("data", "title", "/PWeb_SCA__DGJ_/Restrito/Operador/VerServidor.jsp");
                                    if (msg !== "null") {
                                        alert(msg);
                                        location.reload();
                                    } else {

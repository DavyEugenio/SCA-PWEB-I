...
<html>
        ...
        <div class="site-wrap">
            ...
            <div id="conteudo">
                ...
                <div id="dados">
                    ...
                    Curso: <a href="/PWeb_SCA__DGJ_/Restrito/Servidor/Curso/VerCurso.jsp?id=<%=curso.getId()%>"><%=nome%></a><br>
                    Turma: <a href="/PWeb_SCA__DGJ_/Restrito/Servidor/Turma/VerTurma.jsp?id=<%=turma.getId()%>"><%=turma.getAno() + "." + turma.getSemestre() + " - " + turma.getTurno()%></a><br>
    ...
    <script>
                            window.history.pushState("data", "title", "/PWeb_SCA__DGJ_/Restrito/Servidor/Aluno/VerAluno.jsp?sage=" +<%=aluno.getSage()%>);
    </script>
</html>

    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" onload="Resultado()">
        <div class="site-wrap">
            ...
            <div id="conteudo">
                ...
                <div id="dados">
                    ...
                    Siape: <%=servidor.getSiape()%><br>
                    Nome: <%=servidor.getNome()%><br>
                    Função: <%=servidor.getFuncao()%><br>
                </div>
            </div>
        ...
        <script>
                                function Resultado() {
                                    ...
                                    window.history.pushState("data", "title", "/PWeb_SCA__DGJ_/Restrito/Servidor/VerServidor.jsp");
                                    if (msg !== "null") {
                                        alert(msg);
                                        location.reload();
                                    } else {
